...
/**
 * Function descriptor for cast postgres operator "::".
 * Generally it renders passed arguments that one is expression that represents value object and second that represents type.
 * For example:
 * SQL
 * <pre>{@code
 *  {value}::{type}
