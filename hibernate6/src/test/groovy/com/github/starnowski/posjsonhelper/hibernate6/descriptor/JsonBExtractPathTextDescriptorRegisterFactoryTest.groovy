...
class JsonBExtractPathTextDescriptorRegisterFactoryTest extends Specification {

    def "should return correct function descriptor register"()
    {
        given:
        def tested = new JsonBExtractPathTextDescriptorRegisterFactory()
    ...
    def "function descriptor register should register correct function with key"()
    {
        ...
        then:
        def result = sqmFunctionRegistry.findFunctionDescriptor("jsonb_extract_path_text")
        result.class == JsonBExtractPathTextDescriptor
    }
}
