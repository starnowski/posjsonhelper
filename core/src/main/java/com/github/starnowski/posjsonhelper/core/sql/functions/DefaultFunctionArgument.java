...
public class DefaultFunctionArgument implements IFunctionArgument {
    ...
    public DefaultFunctionArgument(String type, String name) {
        this.type = type;
        this.name = name;
    }
    ...
    public static DefaultFunctionArgument withNameAndType(String name, String type) {
        return new DefaultFunctionArgument(type, name);
    }
