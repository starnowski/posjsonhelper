...
public class TextOperatorFunctionDescriptorRegisterFactory implements FunctionDescriptorRegisterFactory {
    @Override
    public FunctionDescriptorRegister get(Context context, HibernateContext hibernateContext) {
        return new TextOperatorFunctionDescriptorRegister(hibernateContext, true);
    }
}
