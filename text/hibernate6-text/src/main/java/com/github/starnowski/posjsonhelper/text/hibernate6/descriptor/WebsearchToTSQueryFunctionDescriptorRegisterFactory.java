...
public class WebsearchToTSQueryFunctionDescriptorRegisterFactory implements FunctionDescriptorRegisterFactory {
    @Override
    public FunctionDescriptorRegister get(Context context, HibernateContext hibernateContext) {
        return new WebsearchToTSQueryFunctionDescriptorRegister(true);
    }
}