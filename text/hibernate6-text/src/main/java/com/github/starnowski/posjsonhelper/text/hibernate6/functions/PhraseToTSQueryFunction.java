 ...
 * Implemented for HQL function defined by constant {@link com.github.starnowski.posjsonhelper.core.Constants#PHRASETO_TSQUERY_FUNCTION_NAME}
 */
public class PhraseToTSQueryFunction extends AbstractFunctionWithConfigurationAndTextQueryFunction {
     ...
     * @param query         text search query
     */
    public PhraseToTSQueryFunction(NodeBuilder nodeBuilder, SqmExpression<?> configuration, String query) {
        super(nodeBuilder, configuration, query, PHRASETO_TSQUERY_FUNCTION_NAME);
    }
