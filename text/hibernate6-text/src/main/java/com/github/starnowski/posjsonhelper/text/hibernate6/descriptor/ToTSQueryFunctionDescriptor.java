...
public class ToTSQueryFunctionDescriptor extends AbstractFunctionWithConfigurationAndTextQueryFunctionDescriptor<PlainToTSQueryFunction> {
    public ToTSQueryFunctionDescriptor() {
        super(TO_TSQUERY_FUNCTION_NAME);
    }
